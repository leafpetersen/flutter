...
abstract class RenderSector extends RenderObject {
  ...
  Rect get paintBounds =>
      new Rect.fromLTWH(0.0, 0.0, 2.0 * deltaRadius, 2.0 * deltaRadius);

  @override
  Rect get semanticBounds => new Rect.fromLTWH(
...
abstract class RenderDecoratedSector extends RenderSector {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (_decoration.color != null) {
      ...
      final Rect outerBounds = new Rect.fromLTRB(
      ...
      final Rect innerBounds = new Rect.fromLTRB(
...
class RenderBoxToRenderSectorAdapter extends RenderBox
  ...
  Size getIntrinsicDimensions(
    ...
    final SectorDimensions childDimensions = child.getIntrinsicDimensions(
        new SectorConstraints(maxDeltaRadius: maxChildDeltaRadius),
        innerRadius);
  ...
  void performLayout() {
    ...
    child.layout(new SectorConstraints(maxDeltaRadius: maxChildDeltaRadius),
        parentUsesSize: true);
